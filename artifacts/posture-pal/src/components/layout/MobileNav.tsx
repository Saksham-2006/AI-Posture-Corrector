...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-3 left-3 right-3 z-40 grid grid-cols-4 rounded-2xl border border-card-border bg-card/90 p-1.5 shadow-lg backdrop-blur md:hidden">
